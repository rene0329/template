<template>
  <div>
    <el-button-group>
      ...
      <el-tooltip class="item" effect="dark" content="上传流程文件" placement="bottom">
        <el-button type="primary" size="mini" @click="uploadBpmn"><i class="fa fa-upload"></i></el-button>
      </el-tooltip>
